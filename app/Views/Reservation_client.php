                ...
                >
                    ...
                    <tbody>
                        <?php foreach ($reservations as $reservation): ?>
                            <tr>
                                <!-- Utilisez les indices de tableau, pas les propriétés d'objet -->
								...
								<td>
									<div class="dropdown">
										...
										>
										<form id="editReservationForm" method="post" action="<?= base_url('reservations/update') ?>">
										...
										<form id="deleteReservationForm" method="post" action="<?= base_url('reservations/delete') ?>">
